...
#include "Estrategia_Zombie_Curacion.generated.h"

class AZombie_Explosivo;

UCLASS()
class PVZ_USFX_LAB02_API AEstrategia_Zombie_Curacion : public AActor , public IEstrategia_Zombie_Principal
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEstrategia_Zombie_Curacion();
